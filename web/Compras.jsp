<%-- 
    Document   : index
    Created on : 28/08/2022, 4:18:28 p. m.
    Author     : tatin
--%>
    ...
    <body> 
        ...
        <nav class="navbar fixed-top" style="background-color: #e3f2fd">
            <div class="container-fluid">
                ...
                <a class="nav-link" href="Controlador?accion=home"><h3>Mis Compras</h3></a>
        ...
        <div class="container mt-4 pt-5">
            <div class="row">            
                <table class="table tab-pane">
                    ...
                    <tbody>
                        <c:forEach var="o" items="${myCompras}">
                            <tr class="text-center">
                                <td>C00${o.getId()}</td>                                  
                                <td>${o.getFecha()}</td>
                                <td>${o.getMonto()}</td>                                                                                                       
                                <td>P00${o.getIdPago()}</td>                                                                                                       
                                <td>${o.getEstado()}</td>                                                                                                       
                                <td>
                                    <a href="Controlador?accion=verDetalle&idCompra=${o.getId()}">Ver Detalle</a>
                                </td>                                                                                                       
                            </tr>
                        </c:forEach>
                    </tbody>
